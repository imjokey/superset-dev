...
from superset.tags.filters import UserCreatedTagTypeFilter, UserCreatedSysTagTypeFilter
...
class TagRestApi(BaseSupersetModelRestApi):
    ...
    search_filters = {"type": [UserCreatedTagTypeFilter, UserCreatedSysTagTypeFilter]}
